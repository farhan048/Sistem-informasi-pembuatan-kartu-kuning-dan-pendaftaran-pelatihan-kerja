...
@section('title', 'Validasi Kartu Kuning')
@section('content')
    ...
    <div class="container-fluid" id="container-wrapper">
      ...
      <h1 class="h3 mb-0 text-gray-800">Data Kartu Kuning</h1>
      <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="{{url('/admin/dashboard')}}">Home</a></li>
          <li class="breadcrumb-item active" aria-current="page">Data Kartu Kuning</li>
      </ol>
      </div>
              ...
              <tbody>
                ...
                <td>
                  @if ($data->status == 'Diterima')
                    ...
                    @elseif($data->status == 'Belum Diverifikasi')
                  ...
                  <td>
                    ...
                    <button type="submit" class="btn btn-secondary" disabled><i class="fas fa-file-pdf"></i></button>
                  </form>
                    @elseif($data->status == 'Belum Diverifikasi')
                    <form action="" method="GET" class="d-inline">
                      <button type="submit" class="btn btn-secondary" disabled><i class="fas fa-file-pdf"></i></button>
                    ...
                    @else
                    <form action="{{action('CardController@generatePDF', $data->id)}}" method="GET" class="d-inline">
                      <button type="submit" class="btn btn-secondary"><i class="fas fa-file-pdf"></i></button>
                    </form>
                    @endif
      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalScrollableTitle">Detail Pengajuan</h5>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="POST" action=" /validasi/card/{{$data->id}}">
        @method('patch')
      <div class="modal-body">
        @csrf
